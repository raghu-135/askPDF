"""Universal runtime adapter interface with structured unsupported operations."""

from __future__ import annotations

from abc import ABC, abstractmethod
from typing import Any, AsyncIterator, Generic, Mapping, NoReturn, Optional, Protocol, TypeVar
...
class AgentRuntimeAdapter(ABC, Generic[ContextT]):
    ...
    async def update_state(self, request: AgentRuntimeRequest, input: Mapping[str, Any]) -> Mapping[str, Any]:
        self._unsupported("run.update_state", "This runtime does not expose state updates")
