...
def _build_summary_from_trace(trace: Dict[str, Any], resolved_spec: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "metrics": metrics,
        "corrective": _bounded_value(metrics.get("corrective")),
        "retrievalQualityReport": _bounded_value(metrics.get("retrieval_quality_report")),
        "groundingReport": _bounded_value(metrics.get("grounding_report")),
        "nodes": nodes,
        "tools": tools,
