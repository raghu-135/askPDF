...
Prompt composition lives in product_orchestration/prompting.py. This module just
...
def get_web_search_mandate() -> str:
    ...
    return load_prompt("product_orchestration/web_search_mandate.md")
...
def get_deep_research_policy(policy_id: str = DEEP_RESEARCH_POLICY_ID) -> str:
    ...
    return load_prompt("product_orchestration/deep_research_policy.md").strip()
