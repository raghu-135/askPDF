...
# Neutral wire types and normalization are owned by runtime_protocol. Keep the
# product module's constructors and tracing helpers, but do not maintain a
# second wire schema here.
