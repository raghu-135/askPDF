...
def test_agent_task_post_routes_do_not_shadow_static_actions():
    ...
    assert "/agent-tasks/{task_id}/retry-start/responses" in post_paths
    ...
    assert _resolved_endpoint("/agent-tasks/task-1/retry-start/responses") == "respond_to_agent_task_retry_start"
