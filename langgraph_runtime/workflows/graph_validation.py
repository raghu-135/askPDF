...
from langgraph_runtime.agent.tool_registry import (
...
from langgraph_runtime.workflows.enums import GraphSentinel, RouteFunctionId, WorkflowNodeType
...
from langgraph_runtime.workflows.route_registry import (
...
def get_node_catalog() -> Dict[str, Dict[str, Any]]:
    validator_module = sys.modules.get("langgraph_runtime.workflows.validator")
...
class GenericGraphValidator:
    ...
    def collect_errors(self, spec: Dict[str, Any]) -> list[str]:
        ...
        strict_route_completeness = bool(workflow_id)
