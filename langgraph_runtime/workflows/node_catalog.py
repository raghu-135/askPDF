...
TOOL_DOCUMENT_SEARCH_KNOWLEDGE = ToolContractId.DOCUMENT_SEARCH_KNOWLEDGE.value
TOOL_DOCUMENT_INSPECTION = ToolContractId.DOCUMENT_INSPECTION.value
TOOL_DOCUMENT_CONTEXT = ToolContractId.DOCUMENT_CONTEXT.value
...
NODE_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    NODE_RETRIEVAL_WORKER: {
        ...
        "allowed_route_functions": [],
        "allowed_tool_contract_ids": [TOOL_DOCUMENT_SEARCH_KNOWLEDGE, TOOL_DOCUMENT_INSPECTION, TOOL_DOCUMENT_CONTEXT],
    ...
    NODE_DIRECT_ANSWER: {
        ...
        "allowed_route_functions": [],
        "allowed_tool_contract_ids": [TOOL_RESEARCH_CANVAS_PUBLISH],
    ...
    NODE_DEEP_RESEARCH_SUBAGENT: {
        ...
        "allowed_route_functions": [],
        "allowed_tool_contract_ids": [
            TOOL_DOCUMENT_SEARCH_KNOWLEDGE, TOOL_DOCUMENT_INSPECTION, TOOL_DOCUMENT_CONTEXT,
    ...
    NODE_DEEP_TASK_SYNTHESIZER: {
        ...
        "allowed_tool_contract_ids": [TOOL_RESEARCH_CANVAS_PUBLISH], "allowed_parent_types": [NODE_DEEP_COORDINATOR],
