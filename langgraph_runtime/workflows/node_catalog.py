...
NODE_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    NODE_RETRIEVAL_WORKER: {
        ...
        "allowed_route_functions": [],
        "allowed_tool_contract_ids": [TOOL_DOCUMENT_SEARCH_KNOWLEDGE, TOOL_DOCUMENT_INSPECTION, TOOL_DOCUMENT_CONTEXT, TOOL_RESEARCH_CANVAS_PUBLISH],
    ...
    NODE_DEEP_RESEARCH_SUBAGENT: {
        ...
        "allowed_tool_contract_ids": [
            ...
            TOOL_STACKEXCHANGE_REFERENCE, TOOL_YAHOO_FINANCE_NEWS, TOOL_RESEARCH_CANVAS_PUBLISH,
        ],
