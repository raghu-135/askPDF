...
from langgraph_runtime.workflows.enums import NodeEventStatus, WorkflowNodeType
from langgraph_runtime.workflows.planning import worker_nodes_from_spec
...
def _runtime_config(
    *,
    ...
    if claimed_pause_token is not None:
        configurable["claimed_pause_token"] = str(claimed_pause_token)
