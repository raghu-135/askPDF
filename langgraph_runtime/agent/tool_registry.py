...
from langgraph_runtime.agent.tool_contract import ToolWarningCode
from langgraph_runtime.workflows.enums import NodeCapability, NodeCategory, ToolContractId, ToolName, WorkflowNodeType
...
TOOL_CONTRACT_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "search_knowledge": {
        "id": "document_search_knowledge", "category": CAT_RETRIEVAL,
    ...
    "inspect_document": {
        "id": "document_inspection", "category": CAT_RETRIEVAL,
        "allowed_caller_nodes": [NODE_RETRIEVAL_WORKER, NODE_DEEP_RESEARCH_SUBAGENT],
        "allowed_node_types": [NODE_RETRIEVAL_WORKER, NODE_DEEP_RESEARCH_SUBAGENT],
        "required_node_capabilities": [CAP_RETRIEVAL_DOCUMENT],
    ...
    "read_context": {
        "id": "document_context", "category": CAT_RETRIEVAL,
        "allowed_caller_nodes": [NODE_RETRIEVAL_WORKER, NODE_DEEP_RESEARCH_SUBAGENT],
        "allowed_node_types": [NODE_RETRIEVAL_WORKER, NODE_DEEP_RESEARCH_SUBAGENT],
        "required_node_capabilities": [CAP_RETRIEVAL_DOCUMENT],
...
TOOL_FRIENDLY_CONFIG = {
    ...
    "inspect_document": {
        "id": "document_inspection", "display_name": "Inspect Document",
